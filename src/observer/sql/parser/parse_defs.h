...
typedef struct {
  ...
  int is_aggregation;    // 1 if attr is an aggregation
  AggrType aggr_type;    // aggregation type :max, min ,count and etc.
} RelAttr;
